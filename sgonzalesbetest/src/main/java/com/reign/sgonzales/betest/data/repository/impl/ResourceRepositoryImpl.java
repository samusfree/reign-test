package com.reign.sgonzales.betest.data.repository.impl;

import com.reign.sgonzales.betest.data.repository.ResourceRepository;
...
public class ResourceRepositoryImpl <T, I extends Serializable> extends SimpleMongoRepository<T, I> implements
        ResourceRepository<T, I> {
